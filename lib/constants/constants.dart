...
String tapSweepSoundAsset = 'sounds/sweep.wav';
...
At Easy Game (ezezgame.com), the privacy of our visitors is of extreme importance to us. This privacy policy document outlines the types of personal information is received and collected by Easy Game and how it is used.
What Personal Information Do we collect?\n
The information we gather falls into two categories: \n1) Personally identifiable information, which includes personal information you voluntarily supply when you subscribe, order, complete a survey, register for an online discussion, enter a contest or provide your e-mail address and 2) Non personally identifiable information, which includes tracking information collected as you navigate through our sites.
How do we use Personal Information?
We need to collect personal information so that we can provide you with the publications or services you have requested, or so that we can carry out specific statutory functions (or both). The particular purpose for which we collect personal information will either be explained when we collect that information, or will be obvious from the context in which it is collected. Our Data Security @ Easy Game will take reasonable steps to ensure that all information we collect, use or disclose is accurate, complete, up-to-date and stored in a secure environment accessed only by authorized persons. However, we give no warranty against third parties hacking into the data or any unauthorized access to the data by anyone.
Log Files
Like many other Web sites, Easy Game makes use of log files. The information inside the log files includes internet protocol ( IP ) addresses, type of browser, Internet Service Provider ( ISP ), date/time stamp, referring/exit pages, and number of clicks to analyse trends, administer the site, track user’s movement around the site, and gather demographic information. IP addresses, and other such information are not linked to any information that is personally identifiable.
...
If you have any questions about this Privacy Policy please contact us at eznumbergame@gmail.com.
...
Easy Game uses the following cookies on this website, for the following purposes:
Advertisement cookies
Easy Game shows advertisements (banner ads) as a means of income. The networks that deliver the ads place cookies in order to customize the advertisements to your personal preferences. These cookies are placed by Improve Digital, AppNexus and AdSense.
Google cookies
Easy Game uses Google Analytics to analyse the use of this website. Google Analytics generates statistical and other information about website use by means of cookies, which are stored on users’ computers. The information generated relating to our website is used to create reports about the use of the website. Google will store and use this information. Google’s privacy policy is available at: https://www.google.com/privacypolicy.html.
Sharing Cookies
Easy Game allows you to share pages on this website through social networks. The widgets enable this website to use cookies for this functionality.
Refusing cookies
